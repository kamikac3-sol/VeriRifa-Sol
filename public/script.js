...
async function connectWallet(walletType) {
    ...
    try {
        // 🔥 RESETEO COMPLETO DEL ESTADO ANTES DE CONECTAR
...
function disconnectWallet() {
    ...
    // 🔥 FORZAR RENDERIZADO DE SORTEOS PARA ACTUALIZAR BOTONES
    renderRaffles();
